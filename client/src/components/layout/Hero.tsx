  ...
  return (
    <section className="flex flex-col items-center justify-center space-y-2 py-12 md:py-24 lg:py-32">
      <h2 className="font-serif text-3xl tracking-tight sm:text-4xl md:text-5xl">
        Fakturera <span className="text-indigo-500 italic">smartare.</span> Få betalt snabbare.
      </h2>
      ...
      <div className="mt-2 space-y-4 text-center">
        <Show when="signed-out">
          <div className="flex">
            <SignUpButton>
              <button className="rounded-xl bg-indigo-500 px-8 py-3 font-semibold text-white transition-colors duration-100 hover:cursor-pointer hover:opacity-90 active:bg-indigo-600">
                Kom igång gratis
              </button>
            </SignUpButton>
            <a
              href="#"
              className="flex items-center gap-1 px-8 py-3 text-neutral-900 hover:cursor-pointer hover:opacity-80"
            >
