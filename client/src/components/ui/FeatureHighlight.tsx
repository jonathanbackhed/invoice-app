...
export default function FeatureHighlight({ title, text, icon }: Props) {
  return (
    <section className="group col-span-6 flex flex-col justify-between space-y-2 rounded-xl border border-neutral-100 bg-neutral-50 p-8 transition-colors duration-100 **:transition-colors **:duration-100 hover:bg-indigo-500">
